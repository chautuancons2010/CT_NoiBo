...
export async function ProjectIssueCenterPage({ searchParams }: { searchParams: Record<string, string | string[] | undefined> }) {
  ...
  return <div className="page-stack"><header className="page-header"><div className="page-header__copy"><h2>Trung tâm vấn đề</h2></div><Link className="button button--secondary button--md" href="/project-monitoring">Theo dõi dự án</Link></header>
